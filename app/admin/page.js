        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 3 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <Card sx={{ cursor: "pointer" }} onClick={() => router.push("/admin/products")}>
                <CardContent>
              ...
              <Card sx={{ cursor: "pointer" }} onClick={() => router.push("/admin/orders")}>
                <CardContent>
              ...
              <Card sx={{ cursor: "pointer" }} onClick={() => router.push("/admin/users")}>
                <CardContent>
